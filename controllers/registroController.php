...
class registroController extends Controller
{
  ...
  public function index()
  {
    ...
    $this->_view->assign('titulo','Registro de Usuario - '.APP_NAME);
    ...
    if ($this->getInt('enviar') == 1) {
          ...
          if ($this->_registro->verificarEmail($this->getPostParam('email'))) {
            ...
            $this->_view->assign('_error','Esta direccion de email ya está registrada');
            $this->_view->renderizar('index','registro');
            exit;
          }
          ...
          if (!$mail->send()) {
            ...
            $this->_view->assign('_error','Error al Enviar el Correo'. $mail->ErrorInfo);
            $this->_view->renderizar('index','registro');
            exit;
          }
