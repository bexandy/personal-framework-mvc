...
class aclController extends Controller
{
  ...
  {
    $this->_view->assign('titulo','Listas de Control de Acceso - '.APP_NAME);
    $this->_view->renderizar('index');
  }

  public function roles()
  {
    $this->_view->assign('titulo','Administración de Roles - '.APP_NAME);
  ...
  public function permisos_role($roleID)
  {
   ...
   $this->_view->assign('titulo','Administración de Permisos de Role - '.APP_NAME);
